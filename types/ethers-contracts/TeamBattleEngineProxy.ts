...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "./common.js"
  ...
  export interface TeamBattleEngineProxyInterface extends Interface {
  ...
  export interface TeamBattleEngineProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): TeamBattleEngineProxy;
    waitForDeployment(): Promise<this>;

    interface: TeamBattleEngineProxyInterface;
