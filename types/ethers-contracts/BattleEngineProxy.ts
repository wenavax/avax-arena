...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "./common.js"
  ...
  export interface BattleEngineProxyInterface extends Interface {
  ...
  export interface BattleEngineProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): BattleEngineProxy;
    waitForDeployment(): Promise<this>;

    interface: BattleEngineProxyInterface;
