...
const GAMES: Game[] = [
  ...
  { title: 'CAR(D) GAME', sub: 'Card-combo racing — now with real 4-player, server-authoritative multiplayer.', href: '/cardgame', icon: Car, acc: '#f5c542', status: 'TESTNET', pat: 'lines', feat: true, warn: 'Fuji testnet — test AVAX only, no real funds' },
