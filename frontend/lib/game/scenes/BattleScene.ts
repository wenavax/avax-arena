...
export class BattleScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.monsterGfx = this.add.graphics().setDepth(10);
    this.drawMonster(this.monsterGfx, this.monsterBaseX, this.stageY);
  ...
  // ── Draw monster (category-based silhouettes) ──
  ...
  // ── Sprite shake ──
  private shakeSprite(gfx: Phaser.GameObjects.Graphics): void {
    const origX = gfx.x;
    this.tweens.add({
      targets: gfx,
      x: origX + 6,
  ...
  private defeat(): void {
    ...
    // 7. Fade to black and transition
    state.spawnX = 20;
    state.spawnY = 22;
